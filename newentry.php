...
$(function () { 
    $('#container').highcharts({
        ...
        series: [{
			...
			data: [<?php echo join($p00[0], $p01[0], $p02[0], $p03[0], $p04[0], $p05[0], $p06[0], $p07[0], $p08[0], $p09[0], $p10[0], $p11[0], $p12[0], $p13[0], $p14[0], $p15[0], $p16[0], $p17[0], $p18[0], $p19[0], $p20[0], $p21[0], $p22[0], $p23[0]) ?>
